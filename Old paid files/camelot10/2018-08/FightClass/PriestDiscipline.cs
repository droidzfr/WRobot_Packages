...
namespace PriestDiscipline
{
	...
	{
		#region PARAMS
		public const string AUTHOR = "Camelot10";
		public const string VER = "v.0.2";
		...
		void Rotation()
		{
			while (_isLaunched)
			{
				try
				{
					...
					if (CastOnSelf(Spells.ClarityofWill, Me.HealthPercent > 90 && Me.HealthPercent < 100 && !Me.HaveBuff(152118))) continue;
					...
					if (woundedMember != null)
					{
						...
						if (CastOn(Spells.ClarityofWill, woundedMember.Name, woundedMember.HealthPercent > 90 && woundedMember.HealthPercent < 100 && !woundedMember.HaveBuff(152118))) continue;

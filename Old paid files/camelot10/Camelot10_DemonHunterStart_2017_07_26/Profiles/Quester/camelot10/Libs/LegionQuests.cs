...
public class LegionQuests : QuestClass
{
	...
	public const int STORMHEIM_FINAL_ALLIANCE = 39122;
	public const int STORMHEIM_FINAL_HORDE = 38882;
...
";
	...
	public static bool DoAny
	{
		get
		{
			return DoAzsuna || DoValsharah || DoHighmountain || DoStormheim || DoSuramar || DoBrokenShore;
		}
	}
	...
	public static bool NeedAny
	{
		get
		{
			return NeedAzsuna || NeedValsharah || NeedHighmountain || NeedStormheim || NeedSuramar || NeedBrokenShore;
		}
	}
	...
	public static bool NeedBrokenShore
	{
		get
		{
			return Questing.NotComplete(BROKEN_SHORE_FINAL);
		}
	}

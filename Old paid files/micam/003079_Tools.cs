...
public static class Tools
{
	...
	*/
	...
	public static void AuthSystem(string productId)
	{
		...
		{
			new Authentication(CustomQuesterAuthSettings.CurrentSetting.TransactionId, productId);
	...
	public class Authentication
	{
		...
		public Authentication(string orderId, string productId)
		{
			...
			authUrl = "http://88.184.217.17:8080/authenticate?orderId=" + orderId + "&productId=" + productId + "&wRobotAuthKey=" + wRobotAuthKey;
			_isRunning = true;
	...
	public class CustomQuesterAuthSettings : robotManager.Helpful.Settings
	{
		...
		public static bool Load()
		{
			try
			{
				...
				{
					CurrentSetting =
						Load<CustomQuesterAuthSettings>(AdviserFilePathAndName("MicamQuesterAuthSettings", ObjectManager.Me.Name + "." + Usefuls.RealmName + "." + Tools.productId));
					return true;
				}
